        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    VehicleLicencePlate = table.Column<string>(type: "nvarchar(8)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contract_Vehicles_VehicleLicencePlate",
                        column: x => x.VehicleLicencePlate,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contract_VehicleLicencePlate",
                table: "Contract",
                column: "VehicleLicencePlate");
